...
liftM2 f m1 m2 = m1 >>= \v1 -> 
                 ...
                 return (f v1 v2)                    
--                    
-- El evaluador, con control de error (mismo tema que con todos
...
--                      
-- El evaluador, combinando traza y control de error (mismo tema que con todos
--    los que tienen clases en las restricciones de contexto)
--
